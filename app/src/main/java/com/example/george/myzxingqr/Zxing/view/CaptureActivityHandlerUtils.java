...
import com.example.george.myzxingqr.R;
...
public class CaptureActivityHandlerUtils extends Handler {
    private static final String TAG = CaptureActivityHandlerUtils.class
            .getSimpleName();
    ...
    public CaptureActivityHandlerUtils(MainActivity activity, Vector<BarcodeFormat> decodeFormats, String characterSet) {
